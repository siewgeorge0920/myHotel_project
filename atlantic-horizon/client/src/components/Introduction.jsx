...
export default function Introduction() {
  return (
    <section className="relative overflow-hidden py-24 px-6 bg-white">
      ...
      <div className="relative max-w-3xl mx-auto text-center text-gray-900">

        {/* Hotel crest */}
        <div className="mb-8">
          <img src="/images/Logo.png" alt="Atlantic Horizon Crest" className="h-20 w-auto mx-auto opacity-60" />
        </div>
        ...
        <h1 className="font-cinzel text-3xl md:text-5xl tracking-[3px] font-normal mb-3 text-gray-900 uppercase">
          The Atlantic Horizon Manor
        </h1>

        {/* Tagline */}
        <h2 className="font-serif italic text-xl md:text-2xl text-amber-700 mb-12 font-normal">
          Royal Elegance on Ireland's Southwest Coast
        </h2>

        {/* Descriptive paragraphs */}
        <div className="space-y-5 text-base md:text-lg text-gray-600 leading-relaxed font-light tracking-wide">
          <p>
